...
export class HospedagemResponseDto {
  ...
  @ApiProperty({ example: "Pousada Viva-Mar" })
  nome!: string;
  ...
  @ApiProperty({ example: "/uploads/hospedagem/pousadaVivaMar/documento.pdf" })
  documentoPdfUrl!: string;

  @ApiProperty({ example: "/uploads/hospedagem/pousadaVivaMar/logo.webp" })
  logoUrl!: string;
